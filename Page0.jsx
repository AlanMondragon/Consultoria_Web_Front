        ...
        <Container>
          <Row>
            ...
            <Col md={6}>
              ...
              <p>
                <a
                  href="https://www.facebook.com/AsesoriaEspecializadaConsultoriaJAS"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{ display: 'inline-flex', alignItems: 'center', textDecoration: 'none', color: '#60A5FA' }}
                >
              ...
              <p>
                <a
                  href="https://www.instagram.com/somosconsultoriajas"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{ display: 'inline-flex', alignItems: 'center', textDecoration: 'none', color: '#60A5FA' }}
                >
              ...
              <p>
                <a
                  href="https://www.tiktok.com/@consultoriajas"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{ display: 'inline-flex', alignItems: 'center', textDecoration: 'none', color: '#60A5FA' }}
                >
              ...
              <p>
                <a
                  href="https://www.tiktok.com/@consultoriajhonric"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{ display: 'inline-flex', alignItems: 'center', textDecoration: 'none', color: '#60A5FA' }}
                >
              ...
              <p>
                <a
                  href="https://wa.me/message/KXGI4YPWAQ3GC1"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{ display: 'inline-flex', alignItems: 'center', textDecoration: 'none', color: '#60A5FA' }}
                >
              ...
              <p>
                <a
                  href="https://www.threads.net/@somosconsultoriajas"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{
                    display: 'inline-flex',
              ...
              <p>
                ...
                >
                  <Icon
                    ...
                    style={{ color: '#f0f0f0' }}
                  />
                  <span style={{ marginLeft: '8px' }}>Porcentaje de Aprobación</span>
                </a>
              </p>
              <p>
                <a
                ...
                >
                  <Icon
                    ...
                    style={{ color: '#f0f0f0' }}
                  />
                  <span style={{ marginLeft: '8px' }}>ADQUIRIR MANUAL "¿CÓMO LLEVAR UN PROCESO DE VISADO EXITOSO?</span>
                </a>
              </p>
