...
export default function AdminCalendario() {
  ...
  return (
    <div className={styles.page}>
      <AdminSidebar active="calendario" onNavigate={handleNavigate} />

      <main className={styles.main}>
        <header className={styles.topbar}>
          <div>
            <div className={styles.crumb}><span>Principal</span> <span className={styles.crumbSep}>/</span> <span className={styles.accent}>Calendario</span></div>
