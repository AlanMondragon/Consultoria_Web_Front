...
// AdministradorPerfil.jsx) y es de solo lectura, tal como en el mockup:
// no hay backend para que el propio usuario edite su nombre/correo/
// teléfono, así que se mantiene el mismo mensaje de "contacta al Super
// Administrador". "Cambiar contraseña" sí persiste de verdad contra
// PUT /users/password/{id} (actualizarContra), igual que en el panel
// Admin. La "Ubicación" (Jiutepec) es fija como en el mockup: no existe
// un campo de ubicación por usuario en el backend.
  ...
  if (!datos) {
    return (
      <div className={styles.page}>
        <EmpresaSidebar active="perfil" onNavigate={handleNavigate} />
        ...
        <div className={styles.content}>
          <div className={styles.profHero}>
            ...
            <div className={styles.profInfo}>
              ...
              <div className={styles.profRole}><IconStar size={11} /> Empresa · Jiutepec</div>
              <div className={styles.profMeta}>
                <span className={styles.profMetaItem}><IconMail size={13} /> {datos.email}</span>
                {datos.createdAt && (
                  <span className={styles.profMetaItem}><IconClock /> Activa desde {formatActivaDesde(datos.createdAt)}</span>
                )}
              </div>
            </div>
          </div>
            ...
            <div className={styles.secBody}>
              <div className={styles.grid2}>
                ...
                <div className={styles.roRow}>
                  ...
                  <div><div className={styles.roLbl}>Rol</div><div className={styles.roVal}>Empresa</div></div>
                  <span className={styles.roLock}><IconLock size={14} /></span>
                </div>
              </div>
